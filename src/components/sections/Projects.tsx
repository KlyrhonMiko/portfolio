...
const projects: Project[] = [
  {
    ...
    live: "https://koin.klyrhon.me",
    accent: "#14d2a5",
    icon: Wallet,
    mockUrl: "koin.klyrhon.me",
    mockupType: "koin-app",
  },
  {
    title: "pars.",
  ...
  },
  {
    ...
    live: "https://nulll.klyrhon.me",
    accent: "#3b82f6",
    icon: Code2,
    mockUrl: "nulll.klyrhon.me",
