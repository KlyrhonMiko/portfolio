          ...
          <div className="w-[794px] min-h-[1123px] mx-auto bg-white p-12 shadow-lg text-[13px] leading-relaxed">
            ...
            <section className="mb-6">
              ...
              <div className="mt-2 space-y-1 text-[13px]">
                ...
                <p><span className="font-bold">Cisco Networking Academy:</span> <a href="https://www.credly.com/badges/50250e7d-dd3f-45b8-944a-0322efdd0456/public_url" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Prompt Like an Engineer</a> | <em>2026</em></p>
                <p><span className="font-bold">Anthropic:</span> <a href="https://verify.skilljar.com/c/i6x6r67puy7o" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Code 101</a>, <a href="https://verify.skilljar.com/c/zzv6mqrbqzj2" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Code in Action</a>, <a href="https://verify.skilljar.com/c/b95cnb4w5bda" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Frameworks</a>, <a href="https://verify.skilljar.com/c/c45jzpz2c3y9" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Capabilities</a>, <a href="https://verify.skilljar.com/c/2vzhg7kjzxxg" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Agent Skills</a>, <a href="https://verify.skilljar.com/c/nsbroi9399oc" target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:underline">Subagents</a> | <em>2026</em></p>
              </div>
            </section>
